...
# All possible pheno features and combinations, regularize
...
#     model_cox$directory <- stringr::str_replace_all(dir, "log", "cox")
...
for(model in full[1:3]){
    ...
    dir <- stringr::str_replace(model$directory, "cvlog-pcv", "ei")

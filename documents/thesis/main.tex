...
\begin{document}
    ...
    \begin{abstract}
        ...
        large and precise enough to trigger reseach and enable clinical trials for new treatments 
        that outperm R-CHOP on this subpopulation. 

        This thesis aims to develop a computational method that identifies DLBCL patients with 
        progression-free survival (PFS) below two years with higher prevalence and signifantly 
        ...
        signifantly more precise than that identified by the IPI. With more data and new and 
        more accurately measured features in the future, we expect to be able to improve the 
        performance of such models further.
    \end{abstract}

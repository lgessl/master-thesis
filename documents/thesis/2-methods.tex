...
a rectagle set comprises less than $n_\text{min}$ samples. Formally, for a rectangle set $R$, a 
...
In constrast to GLMs with their continuous output, random forests output a binary classification,

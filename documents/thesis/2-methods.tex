...
Fitting a model to our data means finding a parameter $(\hat{\beta}_0, \hat{\beta})$ that minimizes 
the loss function. $(\hat{\beta}_0, \hat{\beta})$ serves as an estimate for the true model. As it 
optimizes a slightly refined likelihood, $(\hat{\beta}_0, \hat{\beta})$ is closely related to a 

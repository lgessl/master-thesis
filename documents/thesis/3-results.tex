...
both include and exclude the expression levels in the predictor of the Gauss, logistic and Cox 
...
\paragraph{Schmitz}
$m^i_\text{Schmitz}$ is a Cox model predicting from discrete features and combinations of up to 
...
On the Lamis test set, meanwhile, $m^*_\text{Schmitz}$ accomplishes all objectives: it tops the 
IPI's precision by more than 12 points, 

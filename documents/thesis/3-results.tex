...
assumptions are. 
We also add the LAMIS group by thresholding the LAMIS score at its 75\%-quantile of the respective 
data set.
...
The results of the intra-trial experiments are encouraging: we beat the precision of the tIPI by 
...
more correlated validation and errors, we need to worry less about overfit validated 

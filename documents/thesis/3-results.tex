...
expression levels nor combinations of discrete features ($n_\text{combi} = 1$). Of note, the model
...
To check this out, we plotted prevalence versus precision for every possibility to threshold 
...
trained to predict OS. Vice versa, for $m^*_\text{Schmitz}$ and $m^\text{Staiger}$, the Reddy data 

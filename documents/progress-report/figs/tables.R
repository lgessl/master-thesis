...
tibble2latex(
    tbl = tbl,
    file = "documents/progress-report/figs/ipi_schmitz.tex",
...
readr::write_csv(auc_tbl, "documents/progress-report/figs/auc.csv") # for my own analysis
...
tibble2latex(
    tbl = auc_tbl,
    file = "documents/progress-report/figs/auc_table.tex",

...
\begin{frame}{My train-test paradigm}
  \begin{tikzpicture}[
    ...
    \draw[decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},xshift=8pt] 
      (\bracex, \bracely) -- (\bracex, \braceuy) node[midway, right=14pt, align=left] {repeat\\ and\\ average};
  \end{tikzpicture}
\end{frame}
